...
STC - http://www.ivoa.net/documents/PR/STC/STC-20050315.html

and

WCS Paper III - http://fits.gsfc.nasa.gov/fits_wcs.html
...
class CoordinateFrame(object):
    ...
    This is kept intentionally very simple so that it can be
    easily extended by custom frames.
