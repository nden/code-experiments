...
def create_region_mask_from_json(mshape, regions, regschema=None, validate=False):
    ...
    Assumes the regions are not overlapping
    ...
    Returns
    -------
    mask : array of shape=mshape
        a byte array where pixels, internal to each region
        have a value, equal to the region's ID.
